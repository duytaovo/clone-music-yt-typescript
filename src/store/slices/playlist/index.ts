...
export const getSongDetail = createAsyncThunk(
  'playlist/getSongDetail',
  payloadCreator(playListApi.getDetailSongFromPlayList)
)
...
export const { addUrlToHistory, removeFirstUrl, updateHistory, updateRoutePre, updateIdPlayList } =
