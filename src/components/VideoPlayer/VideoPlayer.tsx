...
const VideoPlayerSong = ({ playListData, songThumbnail }: { playListData: any; songThumbnail: any }) => {
        ...
        <Card variant='outlined' sx={{ maxWidth: 320, ml: 3, mt: 2, backgroundColor: 'transparent' }}>
          ...
          >
            ...
            <div onClick={handlePlaySong}>
              {isPlay ? (
                <Button className='mb-2 mt-3 flex w-[full] items-center justify-center rounded-[30px] bg-[#75C2F6] py-3 px-3 text-sm uppercase text-white hover:opacity-80'>
                  Tạm dừng
                </Button>
              ) : (
                <Button className='mb-2 mt-3 flex w-[full%] items-center justify-center rounded-[30px] bg-[#75C2F6] py-3 px-3  text-sm uppercase text-white hover:opacity-80'>
            ...
            <div>
              ...
              >
                <animated.div style={springProps}>
                  {like === 0 ? (
                    <FavoriteBorderIcon fontSize='small' style={{ fontSize: '24px', color: '#ffffff' }} />
                  ) : (
                    <FavoriteIcon
                      fontSize='small'
...
export default VideoPlayerSong
